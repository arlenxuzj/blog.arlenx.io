...
updatedAt: 2022-1-09 09:40:20-08:00
---
...
**Master of Science** &nbsp;•&nbsp; Jan 2022 - Current
...
| ---------------------- | -------------------------------------------- |
| JavaScript, Typescript | React, Node.js, Next.js, Electron            |
| HTML5, CSS3            | MUI, Tailwind CSS, Bootstrap                 |
|                        | React Redux, React Query, React Router       |
|                        | jQuery, Firebase, Prisma, Socket.io, Cheerio |
|                        | Docker, Webpack , Storybook, Jest            |
| Python 3.x             | Flask                                        |
...
| -------------------- | ----------------- | -------------- |
| Git (GitHub, Gitlab) | Mac OS, Linux     | GCP, AWS       |
...
- Using React, React Redux, React Query, and MUI to develop the front-end of the application. The application will allow users to browse products, add products to the shopping cart, and purchase products. The application will also allow users to create an account, log in, and log out.
- Using Flask, JWT to develop the back-end of the application. Using Psycopg3 database interface library to connect to the PostgreSQL database.
- Using Nginx, PM2, ZeroSLL to deploy the application on the AWS EC2 instance, and use AWS RDS to store the data.
