...
https://github.com/MaximeHeckel/blog.maximeheckel.com/blob/main/core/components/Buttons/LightDarkSwitcher.tsx
*/
...
const ModeSwitcher = React.forwardRef((props, ref) => {
  ...
  return (
    <StyledButton
      ...
      {...props}
      ref={ref}
      className={umamiEventClass('nav-theme-switcher')}
      initial={false}
